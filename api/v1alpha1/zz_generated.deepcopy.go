...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModelRoleConfig) DeepCopyInto(out *ModelRoleConfig) {
	*out = *in
	if in.Params != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModelRoleConfig.
func (in *ModelRoleConfig) DeepCopy() *ModelRoleConfig {
	if in == nil {
		return nil
	}
	out := new(ModelRoleConfig)
	in.DeepCopyInto(out)
	return out
}
