...
import (
	...
	"github.com/thoughtmesh/thoughtmesh/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "9dab2cb1.thoughtmesh.dev",
	...
	if err := (&controller.MemoryReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "Memory")
		os.Exit(1)
	}
